...
module.exports = zaki = async (zaki, m, msg, M, chatUpdate, store) => {
    try {
...
////////////////////////////////////////////////////	    
	    const textImg = (teks, buffer = fs.readFileSync(global.fakeImg), msg, men) => {
            zaki.sendMessage(m.chat, { text: teks, jpegThumbnail: buffer, mention: men ? men : [] }, { quoted: msg ? mess : msg })
             }
...
//━━━━━━━━━━━━━━━[ 𝗕𝗨𝗔𝗧 𝗚𝗥𝗢𝗨𝗣 ]━━━━━━━━━━━━━━━\\
        ...
        const sender = m.isGroup ? (m.key.participant ? m.key.participant : m.participant) : zaki.decodeJid
...
let buton = [
{ callButton: {displayText: `Instagram`, url: `https://instagram.com/vimukthioshada/`} },
{ urlButton: { displayText: `Call Owner`, phoneNumber : `+94775792013`} },
...
case 'yatim':{
 ...
 @${ytm.split('@')[0]}`
            ...
            let buttons = [
                     ...
                     zaki.sendButtonText(m.chat, buttons, mty, zaki.user.name, m, {mentions: ments})
}
break
case 'piatu':
case 'piyatu': {
 ...
 @${bra.split('@')[0]}`
            ...
            let buttons = [
                     ...
                     zaki.sendButtonText(m.chat, buttons, bruh, zaki.user.name, m, {mentions: ments})
}
break
            case 'jodohku': {
            if (!m.isGroup) throw mess.group
...
let pantek = []
              ...
              zaki.groupParticipantsUpdate(args[0], pantek)
}
break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/vimukthioshada'
                                }
                            }, {
                                callButton: {
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 *V I M U K T H I _ M D* 」\n\n${text}`
                      zaki.send5ButImg(yoi, txt, zaki.user.name, memei, btn)
		}
...
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   zaki.waUploadToServer })
		...
		let { aiovideodl } = require('./lib/scraper')
                ...
                zaki.sendImage(m.chat, thumbnail, `➣ Title : ${title}\n➣ File Size : ${media[0].formattedSize}\n➣ Url : ${url}\n➣ Ext : MP3\n➣ Resolusi : ${args[1] || '128kbps'}`, m)
                zaki.sendMessage(m.chat, { audio: { url: media[0].url }, mimetype: 'audio/mp4', fileName: `${title}.mp3` }, { quoted: m })
            }
            break
		...
		let { aiovideodl } = require('./lib/scraper')
                ...
                if (media[0].formattedSize.split('MB')[0] >= 100000) return m.reply('File Melebihi Batas'+util.format(media))
                zaki.sendMessage(m.chat, { video: { url: media[0].url }, fileName: `${title}.mp4`, mimetype: 'video/mp4', caption: `➣ Title : ${title}\n➣ File Size : ${media[0].formattedSize}\n➣ Url : ${url}\n➣ Ext : MP4\n➣ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
            case 'pinterest': {
                m.reply(mess.wait)
...
headerType: 1
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Zaki, 28, 10, 2005, Dini, 1, 7, 2004`
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} Zaki`
            ...
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} Zaki, 28, 10, 2005`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} Zaki|Dini`
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} Zaki, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} Zaki, 28, 10, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
hx.ttdownloader(q).then( data => {
  zaki.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
	break
case 'gcbot': case 'gc': case 'bot':
m.reply('*Join To Group Official Bot : wa.me/+94775792013*')
break
...
break
	break
            ...
            case 'soundcloud': case 'scdl': {
                ...
                zaki.sendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: m })
            }
            break
...
let txt = ('p')
zaki.sendMessage(m.chat,{ video: { url: data.medias[1].url}},txt,m)})
...
break
  ...
  zaki.sendMessage(m.chat, { text: cimcimi.success})
  break
            case 'public': {
                if (!isCreator) throw mess.owner
                zaki.public = true
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'N:;KiZakiXD;;;'
    + 'FN:KiZakiXD\n'
    + 'ORG:𝙸 𝙰𝚖 vimukthioshada;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=94775792013:+94775792013\n' 
    + 'item1.X-ABLabel:Creator Chitanda - MDt\n'
    + 'item2.EMAIL;type=INTERNET:hellovimukthioshada@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/vimukthioshada\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
zaki.sendMessage(m.chat, { contacts: { displayName: '𝙸 𝙰𝚖 vimukthioshada', contacts: [{ vcard }] } }, { quoted: m })
            }
            break
            case 'list': case 'menu': case 'help': case '?': {
                const Tag = '94775792013'
